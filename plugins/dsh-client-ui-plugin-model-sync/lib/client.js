...
`;
		...
		//#endregion
		//#region config
		const CONFIG = {"sources":{"modelsDev":"https://models.dev/api.json","openRouter":"https://openrouter.ai/api/v1/models"},"settingsNamespaces":["llm-pi-ai"],"metadataTimeoutMs":20000,"maxCandidates":2000};
		//#endregion
		//#region pure helpers
