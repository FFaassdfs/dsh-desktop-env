...
| 仓库简介 **About** | `dsh-desktop environment replica` | ⏳ **待办（需人手工设置，见 36.2）** | — |

About 建议文案：
`dsh-desktop：DeepSeek Harness 桌面启动器（Wails 壳，端口 43080）+ 6 个官方 Web GUI 插件；含离线便携发行包与一键部署/更新脚本。`
